    ...
    switch (currentStep) {
      ...
      case 'startYear': {
        ...
        if (year && year >= 1950 && year <= currentYear) {
          ...
          return `W ${year} roku rozpocząłeś/rozpoczęłaś pracę. W którym roku planujesz przejść na emeryturę? (sugerowany rok: ${defaultRetirement})`;
        }
